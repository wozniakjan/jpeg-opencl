...
badd +40 src/cl_util.h
badd +264 src/cl_util.cpp
badd +1 backup/cl_stuff.h
badd +20 src/jpeg.cl
badd +4 src/square.cl
badd +1 src/jpeg_util.h
badd +1 src/jpeg_util.cpp
badd +1 src/color_transf.cpp
badd +0 src/ycbcr.cl
args Makefile
edit Makefile
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((3 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 181 - ((0 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
181
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 368 - ((40 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
368
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((47 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 469 - ((38 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
469
...
unlet! s:wipebuf
set winheight=1 winwidth=100 shortmess=aoO
