...
badd +1 src/main.cpp
badd +1 ~/.vimrc
badd +1 ~/projects/school/GMU/jpeg/jpge.cpp
badd +34 ~/projects/school/GMU/jpeg/jpge.h
badd +1 src/cl_stuff.h
badd +1 src/cl_stuff.cpp
badd +60 ~/Downloads/mul-dct-2011/zadani.cpp
badd +1 ~/projects/school/GMU/cv1/square.cpp
badd +18 src/cl_util.h
badd +98 src/cl_util.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((7 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
wincmd w
argglobal
edit ~/projects/school/GMU/jpeg/jpge.cpp
setlocal autoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 976 - ((7 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
976
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 254 - ((44 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
254
...
unlet! s:wipebuf
set winheight=1 winwidth=100 shortmess=filnxtToO
